...
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "RohanAutoCrater", group = "Autonomous")
public class FinalAutoCrater extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // Sampling code; will also move to crater - parking
        sample();
    }
